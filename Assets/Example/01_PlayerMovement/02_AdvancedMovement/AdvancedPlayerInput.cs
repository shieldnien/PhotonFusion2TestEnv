...
namespace Example.AdvancedMovement
{
	...
	public sealed class AdvancedPlayerInput : NetworkBehaviour, IBeforeUpdate, IBeforeTick
	{
		public AdvancedInput CurrentInput  => _currentInput;
		public AdvancedInput PreviousInput => _previousInput;
		...
		[Networked]
		private AdvancedInput _currentInput { get; set; }

		private AdvancedInput      _previousInput;
		private AdvancedInput      _accumulatedInput;
		...
		void IBeforeTick.BeforeTick()
		{
			...
			AdvancedInput currentInput = _currentInput;
			...
			if (Object.InputAuthority != PlayerRef.None)
			{
				...
				if (GetInput(out AdvancedInput input) == true)
				{
		...
		private void ProcessStandaloneInput()
		{
			...
			if (keyboard != null)
			{
				...
				_accumulatedInput.Actions.Set(AdvancedInput.JUMP_BUTTON,   keyboard.spaceKey.isPressed);
				_accumulatedInput.Actions.Set(AdvancedInput.SPRINT_BUTTON, keyboard.leftShiftKey.isPressed);
			}
		}
	}
}
