...
namespace Example.TopDownMovement
{
	...
	/// </summary>
	public sealed class TopDownGameplayManager : NetworkBehaviour
	{
		...
		public override void FixedUpdateNetwork()
		{
			if (Runner.IsServer == true)
			{
				...
				PlayerManager<TopDownPlayer>.UpdatePlayerConnections(Runner, SpawnPlayer, DespawnPlayer);
			}
		}
		...
		private void DespawnPlayer(PlayerRef playerRef, TopDownPlayer player)
		{
