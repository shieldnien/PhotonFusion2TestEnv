...
namespace Example.VRMovement
{
	...
	/// </summary>
	public sealed class VRGameplayManager : NetworkBehaviour
	{
		...
		public override void FixedUpdateNetwork()
		{
			if (Runner.IsServer == true)
			{
				...
				PlayerManager<VRPlayer>.UpdatePlayerConnections(Runner, SpawnPlayer, DespawnPlayer);
			}
		}
		...
		private void DespawnPlayer(PlayerRef playerRef, VRPlayer player)
		{
